    ...
    class DPlayer {
        ...
        constructor(option) {
            ...
            this.secondToTime = (second) => {
                ...
                const sec = parseInt(second - min * 60); // 这里可以使用 (second % 60)
        ...
        init() {
            ...
            // 暂停，开始播放视频,这里变量还用的是audio ， 是改的音乐播放器应该
            this.toggle = () => {
            ...
            if (this.option.danmaku) {
                ...
                // 按下快进，快退 / 切换视频进度 停止时，更新弹幕 根据视频的时间匹配弹幕，弹幕有一个时间字段
            ...
            this.setTime = () => {
                ...
                if (this.option.danmaku) {
                    this.playedTime = setInterval(() => {
                        // whether the video is buffering 视频缓冲中, 显示加载按钮
            ...
            // 播放进度条 鼠标按下事件, 暂停更新时间， 监听鼠标移动，抬起事件
            ...
            /**
             * auto hide controller 2s自动隐藏控制栏
             */
            let hideTime = 0;
